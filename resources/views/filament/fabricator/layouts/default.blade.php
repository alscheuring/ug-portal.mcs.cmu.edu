@php
    ...
    // Get navigation - this should match the structure expected by the public layout
    $navigation = []; // You may need to fetch this from a service or model
@endphp
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div class="lg:col-span-3">
                <article class="max-w-none">
                    ...
                    @if($page->content)
                        <div class="prose prose-lg prose-blue max-w-none prose-headings:scroll-mt-6 mt-8">
                            {!! $page->content !!}
                        </div>
                    @endif
                </article>
